...
// The generated portfolio: the 3D / animated design, recolored to the starter
// page's charcoal + forest-green scheme. Driven by REAL GitHub data — reads the
// username from the URL, fetches /api/github/<username>, and renders a hero with
// a floating 3D object, a stats row, the language bars, and tilt project cards.
    ...
    <main className="relative">
      ...
      <section className="relative mx-auto flex min-h-screen max-w-5xl flex-col items-center gap-8 px-6 pt-24 md:flex-row md:pt-0">
        ...
        <div className="flex-1">
          {/* Avatar with a forest-green ring. */}
          <motion.img
