...
// NeonHeroScene: the floating 3D object in the portfolio hero. A distorted,
// slowly spinning icosahedron with a neon material that eases toward the mouse.
// Built with React Three Fiber + drei; kept to one low-poly mesh for perf.
...
export default function NeonHeroScene() {
  return (
